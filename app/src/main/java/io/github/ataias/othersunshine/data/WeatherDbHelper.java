...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        final String SQL_CREATE_WEATHER_TABLE = getCreateWeatherTable();
        final String SQL_CREATE_LOCATION_TABLE = getCreateLocationTable();
    ...
    public String getCreateWeatherTable() {
